      ...
      <div class="container mx-auto " style={{ backgroundImage: `url(${appoinment}) `, }}>
        <div class="flex flex-col lg:flex-row items-center  mx-4 md:mx-0  ">
          ...
          <div className=" flex-1 ">
            <img src={doctor} class=" mt-[-100px] hidden lg:block  " alt="" />
          </div>
          {/* <div className="w-full md:w-1/2 pr-0 md:pr-10"> */}
          <div className="flex-1 pr-0 md:pr-28 py-6">
            <h2 className="text-xl text-secondary mb-5 font-bold">Appointment</h2>
            <h1 class="text-4xl font-bold mt-5 md:mt-0 text-white">
